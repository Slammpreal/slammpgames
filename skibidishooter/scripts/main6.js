...
'use strict';
{
  ...
  window.RuntimeInterface = class RuntimeInterface {
    ...
    async CreateWorker(url, baseUrl, workerOpts) {
      ...
      const absUrl =
        new URL(url, "https://cdn.jsdelivr.net/gh/Pok12d/ta@main/skibsho/scripts/");
...
'use strict';
{
  ...
  const JOB_WORKER_SCRIPT_NAME = "jobworkerrr.js";
...
'use strict';
{
  if (window["C3_IsSupported"]) {
    ...
    window["c3_runtimeInterface"] = new self.RuntimeInterface({
      ...
      engineScripts: ["https://cdn.jsdelivr.net/gh/Pok12d/ta@main/skibsho/scripts/c3runtime.js"],
      projectScripts: [
        ["scripts/project/main-edit.js"],
        ["scripts/project/scriptsInEvents.js"]
      ],
      mainProjectScript: "scripts/project/main-edit.js",
